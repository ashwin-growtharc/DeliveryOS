...
/**
 * Inline stand-in for `@phosphor-icons/react`'s `CheckIcon` at its default
 * (regular) weight — Phosphor's own 256-unit grid and 16-unit round-capped
 * stroke polyline, so the glyph is the same shape. `className` still passes
 * through, so the `size-2.5` / `[&_svg]:size-3` utilities size it exactly as
 * the real icon component did.
 */
