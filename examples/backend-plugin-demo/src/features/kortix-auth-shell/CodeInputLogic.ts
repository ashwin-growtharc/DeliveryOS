 ...
 *
 * Ported verbatim from the source -- this file has no backend/provider
 * coupling at all, so no genericization was needed, just the mechanical
 * react-import fix (it has none: it's plain TS, no React import to begin
 * with).
 */
